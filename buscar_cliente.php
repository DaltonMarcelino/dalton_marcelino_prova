...
<body>
    ...
    <!-- Forms para buscar o ID ou NOME do cliente -->
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                    <?php foreach($usuarios as $usuario): ?>
                        <tr>
                            <td>
                                <?=htmlspecialchars($usuario['id_cliente'])?></td>
                                <td><?=htmlspecialchars($usuario['nome_cliente'])?></td>
                                <td><?=htmlspecialchars($usuario['endereco'])?></td>
                                <td><?=htmlspecialchars($usuario['telefone'])?></td>
                                <td><?=htmlspecialchars($usuario['email'])?></td>
                            <td>
                                <a href="alterar_cliente.php?id=<?=htmlspecialchars($usuario['id_cliente'])?>" class="btn btn-sm btn-primary me-1">Alterar</a>
                                <a href="excluir_cliente.php?id=<?=htmlspecialchars($usuario['id_cliente'])?>" class="btn btn-sm btn-danger"
